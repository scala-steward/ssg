 ...
 *
 * Compression tests for mangleprops.
 * Ported from: terser/test/compress/mangleprops.js (3 test cases)
 *
...
final class CompressManglepropsSuite extends munit.FunSuite {
  ...
  // =========================================================================
  test("computed_inline_string_keep_quoted_no_computed_props".fail) {
    assertCompresses(
      input = """let quoted_obj = {
            ['_obj_prop']: 'bar',
            ['_obj_method']() {},
  ...
  // =========================================================================
  test("computed_inline_string_keep_quoted_computed_props".fail) {
    assertCompresses(
      input = """let quoted_obj = {
            ['_obj_prop']: 'bar',
            ['_obj_method']() {},
