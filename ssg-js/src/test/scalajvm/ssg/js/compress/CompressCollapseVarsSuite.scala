...
final class CompressCollapseVarsSuite extends munit.FunSuite {
  ...
  // =========================================================================
  test("collapse_vars_side_effects_2") {
    assertCompresses(
  ...
  // =========================================================================
  test("collapse_vars_do_while_drop_assign") {
    assertCompresses(
      input = """function f1(y) {
  ...
  // =========================================================================
  test("collapse_vars_short_circuit") {
    assertCompresses(
  ...
  // =========================================================================
  test("collapse_vars_short_circuited_conditions") {
    assertCompresses(
  ...
  // =========================================================================
  test("toplevel_single_reference") {
    assertCompresses(
      input = """var a;
        for (var b in x) {
            var a = b;
