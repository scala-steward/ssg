...
final class CompressSwitchSuite extends munit.FunSuite {
  ...
  // =========================================================================
  test("trim_empty_last_branches_3") {
    assertCompresses(
      input = """switch (id(1)) {
            case 1:
                console.log("PASS")
  ...
  // =========================================================================
  test("trim_side_effect_free_branches_falling_into_default") {
    assertCompresses(
      input = """switch (id(1)) {
            case 0:
                "no side effect"
  ...
  // =========================================================================
  test("trim_side_effect_free_branches_falling_into_default_2") {
    assertCompresses(
      input = """switch (id(1)) {
            default:
            case 0:
