...
/** A macro definition: either a string, a MacroExpansion, or a function that takes a MacroContextInterface and returns a string or MacroExpansion.
  */
...
object MacroDef {
  ...
  /** All registered global/built-in macros. `macros.js` exports this same dictionary again and makes it public. `Parser.js` requires this dictionary via `macros.js`.
    */
