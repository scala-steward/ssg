 ...
 *
 * Ported from: liqp/src/main/java/liqp/nodes/GtEqNode.java
 ...
 *
 * Covenant: full-port
 * Covenant-java-reference: liqp/src/main/java/liqp/nodes/GtEqNode.java
...
class GtEqNode(lhs: LNode, rhs: LNode) extends ComparingExpressionNode(lhs, rhs, true) {
