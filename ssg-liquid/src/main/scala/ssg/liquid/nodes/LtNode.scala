 ...
 *
 * Ported from: liqp/src/main/java/liqp/nodes/LtNode.java
 ...
 *
 * Covenant: full-port
 * Covenant-java-reference: liqp/src/main/java/liqp/nodes/LtNode.java
...
class LtNode(lhs: LNode, rhs: LNode) extends ComparingExpressionNode(lhs, rhs, true) {
