...
object LiquidSupportPlatform {
  ...
  /** Stub implementation that returns an empty map on Scala Native.
    *
    * Reflection is not available on Native. For objects to be usable in Liquid templates, implement LiquidSupport directly.
    */
