...
/** Gap-fill tests ported from liqp's tags/WhitespaceControlTest.java — 4 missing tests.
  *
  * All output in this test class is tested against Ruby 2.3.1 and Liquid 4.0.0. The existing BlocksSuite already covers: lhs strip, rhs strip, both sides strip, all strip. This adds: noStrip,
  * twoLhsStrip, twoRhsStrip, defaultStrip.
  */
