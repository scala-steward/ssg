 ...
 *
 * Ported from: flexmark/src/main/java/com/vladsch/flexmark/ast/BulletList.java
 * Original: Copyright (c) 2016-2023 Vladimir Schneider
 * Original license: BSD-2-Clause
 *
 * Covenant: full-port
 * Covenant-java-reference: flexmark/src/main/java/com/vladsch/flexmark/ast/BulletList.java
...
class BulletList extends ListBlock {
  ...
  var openingMarker: Char = scala.compiletime.uninitialized
