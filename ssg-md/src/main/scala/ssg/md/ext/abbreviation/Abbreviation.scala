 ...
 *
 * Covenant: full-port
 * Covenant-java-reference: flexmark-ext-abbreviation/src/main/java/com/vladsch/flexmark/ext/abbreviation/Abbreviation.java
...
/** A node containing the abbreviated text that will be rendered as an abbr tag or a link with title attribute
  */
class Abbreviation(chars: BasedSequence, val abbreviation: BasedSequence) extends Node(chars), DoNotDecorate, DoNotLinkDecorate, ReferencingNode[AbbreviationRepository, AbbreviationBlock] {
