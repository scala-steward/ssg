...
object TaskListExtension {
  ...
  val ITEM_DONE_MARKER: DataKey[String] = new DataKey[String]("ITEM_DONE_MARKER", "<input type=\"checkbox\" class=\"task-list-item-checkbox\" checked=\"checked\" disabled=\"disabled\" readonly=\"readonly\" />&nbsp;")
  val ITEM_NOT_DONE_MARKER: DataKey[String] = new DataKey[String]("ITEM_NOT_DONE_MARKER", "<input type=\"checkbox\" class=\"task-list-item-checkbox\" disabled=\"disabled\" readonly=\"readonly\" />&nbsp;")
  ...
  /** Priorities corresponding to Parser.LISTS_ITEM_PREFIX_CHARS.
