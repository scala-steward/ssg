 ...
 *
 * Ported from: flexmark-ext-ins/src/main/java/com/vladsch/flexmark/ext/ins/Ins.java
 * Original: Copyright (c) 2016-2023 Vladimir Schneider
 * Original license: BSD-2-Clause
 *
 * Covenant: full-port
 * Covenant-java-reference: flexmark-ext-ins/src/main/java/com/vladsch/flexmark/ext/ins/Ins.java
...
class Ins() extends Node, DelimitedNode {
  ...
  def this(chars: BasedSequence, insBlockText: String) = {
    this()
    this.chars = chars
