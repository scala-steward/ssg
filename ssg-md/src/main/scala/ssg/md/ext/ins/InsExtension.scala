 ...
 *
 * Covenant: full-port
 * Covenant-java-reference: flexmark-ext-ins/src/main/java/com/vladsch/flexmark/ext/ins/InsExtension.java
...
/** Extension for ins.
  ...
  */
class InsExtension private () extends Parser.ParserExtension, HtmlRenderer.HtmlRendererExtension {
