 ...
 *
 * Covenant: full-port
 * Covenant-java-reference: flexmark-ext-jekyll-front-matter/src/main/java/com/vladsch/flexmark/ext/jekyll/front/matter/JekyllFrontMatterExtension.java
...
/** Extension for jekyll_front_matters.
  ...
  */
class JekyllFrontMatterExtension private () extends Parser.ParserExtension, HtmlRenderer.HtmlRendererExtension, Formatter.FormatterExtension {
