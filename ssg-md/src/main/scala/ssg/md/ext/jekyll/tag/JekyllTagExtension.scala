...
object JekyllTagExtension {
  ...
  val TAG_LIST: DataKey[JList[JekyllTag]] = new DataKey[JList[JekyllTag]]("TAG_LIST", new ssg.md.util.data.NotNullValueSupplier[JList[JekyllTag]] { override def get: JList[JekyllTag] = new ArrayList[JekyllTag]() })
