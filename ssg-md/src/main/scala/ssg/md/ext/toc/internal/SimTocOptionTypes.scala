 ...
 *
 * Ported from: flexmark-ext-toc/src/main/java/com/vladsch/flexmark/ext/toc/internal/SimTocOptionTypes.java
 * Original: Copyright (c) 2016-2023 Vladimir Schneider
 * Original license: BSD-2-Clause
 *
 * Covenant: full-port
 * Covenant-java-reference: flexmark-ext-toc/src/main/java/com/vladsch/flexmark/ext/toc/internal/SimTocOptionTypes.java
...
/** Option parsers for SimTOC blocks. In Java these are enum members; here they are array entries. */
object SimTocOptionTypes {

  private val OPTION_BULLET:          String = "bullet"
  private val OPTION_NUMBERED:        String = "numbered"
  private val OPTION_MARKDOWN:        String = "markdown"
  private val OPTION_HTML:            String = "html"
  ...
  val OPTIONS: Array[OptionParser[TocOptions]] = Array(
    ...
    new BooleanOptionParser[TocOptions](OPTION_HTML) {
      override protected def isOptionSet(options: TocOptions): Boolean    = options.isHtml
      override def setOptions(options:            TocOptions): TocOptions = options.withIsHtml(true)
    },
    new BooleanOptionParser[TocOptions](OPTION_MARKDOWN) {
      override protected def isOptionSet(options: TocOptions): Boolean    = !options.isHtml
      override def setOptions(options:            TocOptions): TocOptions = options.withIsHtml(false)
    },
