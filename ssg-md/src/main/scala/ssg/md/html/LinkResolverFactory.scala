 ...
 *
 * Covenant: full-port
 * Covenant-java-reference: flexmark/src/main/java/com/vladsch/flexmark/html/LinkResolverFactory.java
...
trait LinkResolverFactory extends (LinkResolverBasicContext => LinkResolver), Dependent {
