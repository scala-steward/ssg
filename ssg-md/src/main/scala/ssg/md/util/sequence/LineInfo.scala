 ...
 *
 * Covenant: full-port
 * Covenant-java-reference: flexmark-util-sequence/src/main/java/com/vladsch/flexmark/util/sequence/LineInfo.java
...
import ssg.md.util.misc.{ BitField, BitFieldSet, EnumBitField, Utils }
