 ...
 *
 * Ported from: flexmark-util-sequence/src/main/java/com/vladsch/flexmark/util/sequence/mappers/SpecialLeadInCharsHandler.java
 * Original: Copyright (c) 2016-2023 Vladimir Schneider
 * Original license: BSD-2-Clause
 *
 * Covenant: full-port
 * Covenant-java-reference: flexmark-util-sequence/src/main/java/com/vladsch/flexmark/util/sequence/mappers/SpecialLeadInCharsHandler.java
...
/** Handles lead-in characters that match a predicate when the sequence is exactly one character.
  */
class SpecialLeadInCharsHandler protected (val predicate: CharPredicate) extends SpecialLeadInHandler {
...
object SpecialLeadInCharsHandler {

  def create(leadInChar: Char): SpecialLeadInCharsHandler =
    new SpecialLeadInCharsHandler(CharPredicate.anyOf(leadInChar))

  def create(leadInChars: CharSequence): SpecialLeadInCharsHandler =
    new SpecialLeadInCharsHandler(CharPredicate.anyOf(leadInChars))
}
