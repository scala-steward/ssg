 ...
 *
 * Ported from: flexmark-core-test/.../renderer/ComboCoreSpecTest.java
...
/**
 * Core CommonMark spec test — parses ast_spec.md and validates
 * each example's markdown→HTML rendering.
 */
