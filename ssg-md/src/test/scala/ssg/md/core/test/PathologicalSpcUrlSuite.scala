 ...
 *
 * Ported from: flexmark-core-test/.../html/PathologicalSpcUrlTest.java
...
/** Pathological test cases for the parser (spcInLinkUrls = true).
  *
  * These tests verify that the parser handles extreme/pathological inputs without hanging or running out of resources, with space-in-link-urls enabled.
  */
final class PathologicalSpcUrlSuite extends munit.FunSuite {
