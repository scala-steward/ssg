 ...
 *
 * Ported from: flexmark-ext-aside/.../AsideParserTest.java Original: Copyright (c) 2016-2023 Vladimir Schneider Original license: BSD-2-Clause */
package ssg
package md
package ext
package aside
...
final class AsideParserTest extends munit.FunSuite {
  ...
  test("test_escape") {
    val parser = Parser.builder().extensions(Collections.singleton(AsideExtension.create())).build()
