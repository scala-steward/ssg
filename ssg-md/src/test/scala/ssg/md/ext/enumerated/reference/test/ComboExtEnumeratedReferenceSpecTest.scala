 ...
 *
 * Ported from: flexmark-ext-enumerated-reference/.../ComboExtEnumeratedReferenceSpecTest.java Original: Copyright (c) 2016-2023 Vladimir Schneider Original license: BSD-2-Clause */
package ssg
package md
package ext
package enumerated
