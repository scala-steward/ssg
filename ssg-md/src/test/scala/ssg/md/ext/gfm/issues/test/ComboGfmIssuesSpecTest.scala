 ...
 *
 * Ported from: flexmark-ext-gfm-issues/.../ComboGfmIssuesSpecTest.java
...
object ComboGfmIssuesSpecTest {
  ...
  val OPTIONS_MAP: java.util.Map[String, DataHolder] = {
    ...
    map.put("root", new MutableDataSet().set(GfmIssuesExtension.GIT_HUB_ISSUES_URL_ROOT, "https://github.com/vsch/flexmark-java/issues").toImmutable)
    ...
    map.put("bold", new MutableDataSet()
      .set(GfmIssuesExtension.GIT_HUB_ISSUE_HTML_PREFIX, "<strong>")
      .set(GfmIssuesExtension.GIT_HUB_ISSUE_HTML_SUFFIX, "</strong>")
      .toImmutable)
    map
  }
}
