 ...
 *
 * Ported from: flexmark-ext-gfm-strikethrough/.../ComboStrikethroughSpecTest.java Original: Copyright (c) 2016-2023 Vladimir Schneider Original license: BSD-2-Clause */
package ssg
package md
package ext
package gfm
