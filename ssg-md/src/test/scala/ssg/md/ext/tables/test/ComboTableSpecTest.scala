 ...
 *
 * Ported from: flexmark-ext-tables/.../ComboTableSpecTest.java Original: Copyright (c) 2016-2023 Vladimir Schneider Original license: BSD-2-Clause */
package ssg
package md
package ext
package tables
...
object ComboTableSpecTest {
  ...
  val OPTIONS_MAP: java.util.Map[String, DataHolder] = {
    ...
    map.put("sub-parse2", new MutableDataSet().set(TestUtils.SOURCE_SUFFIX, "\n").toImmutable)
    map
  }
}
