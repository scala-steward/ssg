 ...
 *
 * Ported from: flexmark-ext-wikilink/.../ComboWikiLinkSpecTest.java Original: Copyright (c) 2016-2023 Vladimir Schneider Original license: BSD-2-Clause */
package ssg
package md
package ext
package wikilink
...
object ComboWikiLinkSpecTest {
  ...
  val OPTIONS:           DataHolder       = new MutableDataSet().set(Parser.EXTENSIONS, Arrays.asList(WikiLinkExtension.create(), TypographicExtension.create())).toImmutable
