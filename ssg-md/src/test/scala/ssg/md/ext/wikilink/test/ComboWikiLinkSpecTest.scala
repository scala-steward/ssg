 ...
 *
 * Ported from: flexmark-ext-wikilink/.../ComboWikiLinkSpecTest.java
...
final class ComboWikiLinkSpecTest extends RendererSpecTestSuite {
  override def specResource: ResourceLocation = ComboWikiLinkSpecTest.RESOURCE_LOCATION
  override def defaultOptions: Nullable[DataHolder] = Nullable(ComboWikiLinkSpecTest.OPTIONS)
  override def optionsMap: java.util.Map[String, ? <: DataHolder] = ComboWikiLinkSpecTest.OPTIONS_MAP
}

object ComboWikiLinkSpecTest {
  val SPEC_RESOURCE: String = "/ssg/md/ext/wikilink/test/ext_wikilink_ast_spec.md"
  val RESOURCE_LOCATION: ResourceLocation = ResourceLocation.of(classOf[ComboWikiLinkSpecTest], SPEC_RESOURCE)
  ...
  val OPTIONS_MAP: java.util.Map[String, DataHolder] = {
    ...
    map.put("link-prefix-absolute", new MutableDataSet()
      .set(WikiLinkExtension.LINK_PREFIX, "/relative/")
      .set(WikiLinkExtension.LINK_PREFIX_ABSOLUTE, "/absolute/")
      .toImmutable)
    ...
    map.put("image-prefix-absolute", new MutableDataSet()
      .set(WikiLinkExtension.IMAGE_PREFIX, "/relative/images/")
      .set(WikiLinkExtension.IMAGE_PREFIX_ABSOLUTE, "/absolute/images/")
      .toImmutable)
    ...
    map.put("custom-link-escape", new MutableDataSet()
      .set(WikiLinkExtension.LINK_ESCAPE_CHARS, " +<>")
      .set(WikiLinkExtension.LINK_REPLACE_CHARS, "____")
      .toImmutable)
