...
abstract class RenderingTestCase extends SpecExampleProcessor {
   ...
   */
  override def addFullSpecExample(exampleRenderer: SpecExampleRenderer, exampleParse: SpecExampleParse, exampleOptions: Nullable[DataHolder], ignoredTestCase: Boolean, html: String, ast: Nullable[String]): Unit = {
    // default no-op
  }
