 ...
 *
 * Ported from: flexmark-test-util/src/main/java/com/vladsch/flexmark/test/util/SettableExtractedInstance.java
 ...
 *
 * @tparam T type for the container setting
 * @tparam S type for the setting
 */
