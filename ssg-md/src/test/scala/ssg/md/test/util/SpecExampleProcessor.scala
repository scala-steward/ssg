...
trait SpecExampleProcessor {
   ...
   */
  def addFullSpecExample(exampleRenderer: SpecExampleRenderer, exampleParse: SpecExampleParse, exampleOptions: Nullable[DataHolder], ignoredTestCase: Boolean, html: String, ast: Nullable[String]): Unit
}
